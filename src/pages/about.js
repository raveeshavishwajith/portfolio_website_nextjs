...
import profilePic from "../../public/images/profile/Raveesha_Vishwajith.jpg";
...
const About = () => {
  return (
    <>
      <Head>
        <title>Raveesha Vishwajith | About Page</title>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8 ">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4 md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi, I&apos;m Raveesha Vishwajith, a web developer and UI/UX designer with a
            ...
            <div className="col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light p-8 dark:bg-dark dark:border-light xl:col-span-4 md:col-span-8">
              ...
              <Image
                ...
                className="w-full h-auto rounded-2xl md:order-1"
                priority
